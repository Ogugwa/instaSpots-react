      ...
      {isEditing ? (
        ...
        <>
          <div className="flex flex-col justify-center items-center gap-4 w-full md:flex-row md:items-start md:justify-between">
            <div className="flex justify-center items-center">
              <img
                src={profileData.picture}
                alt='Profile'
                className='w-20 h-20 md:w-32 md:h-32 lg:w-[11.875rem] lg:h-[11.875rem] object-cover'
              />
            </div>
            <div className='flex flex-col justify-center items-center w-full md:w-[70%] md:items-start'>
              ...
              <button 
                ...
                className='flex items-center justify-center gap-2 mt-3 text-[#212121B2] hover:text-[#212121] transition-colors'
              >
          ...
          <div className='flex flex-col gap-2 w-full mt-3 md:items-end md:mt-20 lg:mt-[7.5rem]'>
            <button className='flex items-center justify-center gap-2 rounded-xl bg-[#212121] text-[#FCF5E5] w-full h-12 md:w-36 hover:bg-[#333333] transition-colors'>
