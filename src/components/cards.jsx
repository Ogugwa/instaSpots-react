...
const Cards = () => {
  ...
  },
  {
    ...
    const isRed = path.getAttribute('stroke') === '#ef4444';
    
    // Toggle stroke and fill colors
    path.setAttribute('stroke', isRed ? '#212121' : '#ef4444');
    path.setAttribute('fill', isRed ? 'none' : '#ef4444');
    };
  return (
    <div className="flex flex-col items-center justify-center mt-6 font-poppins font-medium">
